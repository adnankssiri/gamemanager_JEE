package com.example.gamesmanager.gamesmanager;
...
public class GamesManagerApplication {
	com.example.gamesmanager.gamesmanager.services.Game.GameServices gameServices;
	com.example.gamesmanager.gamesmanager.services.Ticket.TicketServices ticketServices;
	...
	CommandLineRunner commandLineRunner (){
		return args -> {
			...
			Stream.of(
				...
				com.example.gamesmanager.gamesmanager.dtos.outputDtos1.GameOutputDto gameOutputDto = null;
				try {
